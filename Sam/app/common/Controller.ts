module App {
    ...
    /**
     * Все angular-контроллеры приложения реализуют этот интерфейс
     *
    ...
    /**
     * Все angular-контроллеры страницы сайта реализуют этот интерфейс
     *
     * Наследуйте все ангуляр контроллеры страницы сайта от этого класса.
     * Вам будут доступны основные сервисы ангуляра, как свойства этого класса.
     */ 
