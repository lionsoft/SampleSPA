(function () {
    ...
    RegExp.rebuild = function (regexp, options) {
        ...
        options = options || {};
        var flags = "";
        if (options.startsWith && !source.StartsWith("^"))
            source = "^" + source;
        if (options.endsWith && !source.EndsWith("$"))
            source = source + "$";
        if (options.ignoreCase === undefined && regexp.ignoreCase || options.ignoreCase !== undefined && options.ignoreCase)
            flags = "i";
        if (options.global === undefined && regexp.global || options.global !== undefined && options.global)
            flags = "g";
        if (options.multiline === undefined && regexp.multiline || options.multiline !== undefined && options.multiline)
            flags = "m";
...
//# sourceMappingURL=js.net.string.js.map