...
module App {
    ...
    export interface IRouteSettings {
        ...
        /**
         * Html-разметка пункта меню (или ключ локализации) верхнего пункта меню.
         * Верхние пункты сортируются по этому значению.
         */
        topMenu?: string;
        ...
        nav?: number;
        /**
         * Html-разметка пункта меню (или ключ локализации)
         */
        content?: string;
    }
